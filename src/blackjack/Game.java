...
public class Game {
    ...
    public static void initialCards(){
        ...
        //Increasing the lenght in which the player hand can hold the next card.        
        	int p = 2;
        	String[] playerHand2 = Arrays.copyOf(playerHand, playerHand.length+1);	
        	playerHand2[2] = card;
        	System.out.println("You draw: " + card);
        	
        	System.out.println("Your hand: " + Arrays.toString(playerHand2));
